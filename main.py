...
def get_address_final(baseaddress, secret_vk, major, minor):
    ...
    print('m en hex es:                ', m.hex())
    print('el escalar reducido de m es:', scalar_reduce(m).hex())
    # print(scalarmult_B(scalar_reduce(m)))
    # print(D)
...
acoaco = get_address_final(baseaddress, secret_vk, 0, 6)
